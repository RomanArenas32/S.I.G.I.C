...
export const ListaEfectivos = () => {
  ...
  return (
    <div className="flex flex-col">
      ...
      <h2 className="font-semibold text-center">Lista de efectivos activos</h2>
        ...
        {efectivos.map((ef) => (
          <div key={ef.legajo}>
            <div className="flex md:flex-row gap-2 font-semibold text-lg justify-between my-4">
              ...
              <button
                className="text-black cursor-pointer uppercase bg-white px-4 py-2 active:translate-x-0.5 active:translate-y-0.5 hover:shadow-[0.5rem_0.5rem_#F44336,-0.5rem_-0.5rem_#00BCD4] transition"
                onClick={() => userDetail(ef)}
              >
                Detalles
              </button>
            </div>
